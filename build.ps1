<#
.SYNOPSIS
    Builds (and optionally pushes) the content-manager Docker image with the latest tag.
    Windows counterpart of build.sh.

.EXAMPLE
    .\build.ps1
    Builds duckautomata/content-manager:latest, lists the images, then asks whether to push.
...
.EXAMPLE
    .\build.ps1 -Tag 1.4.0
    Builds duckautomata/content-manager:1.4.0 instead of :latest.
...
# --- Configuration ---
$ImageName = 'duckautomata/content-manager'
